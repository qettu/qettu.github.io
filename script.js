...
log("I have coded a program (using C++ and LunarG's Vulkan SDK) that can load 3D-models and textures from .gltf files and pre-mipmapped KTX-texture files. The base of program is made by following Alexander Overvoorde's Vulkan tutorial (hyperlink below). I have later added Blinn-Phong lighting and some other features. The main code includes 3000 rows of  C++-code. In addition, program contains GLSL-code translated into SPIR-V. ", tekstialue3)
log("This old project combined wildlife photografing and programming. This Android app made with Android-Studio and Java allows user to save butterfly observations (weather, temperature, location and speciec) and browse common butterflies based on their characteristics.", tekstialue4)
