...
log("Olen toteuttanut Vulkanilla ohjelman, joka pystyy lataamaan 3D-malleja .obj-tiedostoista ja liittämään niihin tekstuurin. Ohjelman runko on toteutettu seuraamalla Alexander Overvoorden Vulkan tutoriaalia (linkki ohessa). Myöhemmin olen lisännyt ohjelmaan Blinn-Phong valaistusmallin ja muutamia muita ominaisuuksia. Pääohjelmassa on yli 3000 riviä C++-koodia (suuri osa kommentteja). Lisäksi ohjelmaan kuuluu GLSL-koodia.", tekstialue3)
