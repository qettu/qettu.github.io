...
var paperielementti = document.getElementsByClassName("muistiopaperi");
...
function adjustFontSize() {
	...
	for (var i = 0; i < kaikkiTekstielementit.length; i++) {
		kaikkiTekstielementit[i].style.fontSize = paperielementti[0].offsetHeight/33.267+'px';
	}
}
...
tekstialue4 = document.getElementById("tekstialue4");
